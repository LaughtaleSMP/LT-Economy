...
export const DAILY_CFG = {
  ...
  // [REC-3] Reward setelah hari ke-7 — cegah churn minggu ke-2
  // Setelah siklus 7 hari selesai:
  //   - Flat: 50 koin/login tiap hari (tidak lagi 0)
  //   - Milestone per-7-hari: +350 koin bonus (hari 14, 21, 28, ...)
  //   - Milestone hari 30: +1.500 koin (hadiah setia sebulan)
  LOGIN_AFTER7_FLAT:      50,   // koin per login setelah streak > 7
  LOGIN_MILESTONE_EVERY7: 350,  // bonus tiap kelipatan 7 (hari 14, 21, ...)
  LOGIN_MILESTONE_30:     1500, // bonus khusus hari total ke-30
...
// ═══════════════════════════════════════════════════════════
// SFX — Sound feedback untuk Daily UI
// Pola sama dengan auction/config.js & store: {id, pitch, vol}.
// Pakai vanilla sound id (random.* / note.*) supaya tidak butuh
// resource pack tambahan.
// ═══════════════════════════════════════════════════════════
export const SFX = {
  OPEN:        { id: "random.click",    pitch: 1.3, vol: 0.7 },  // buka menu
  PAGE:        { id: "random.click",    pitch: 1.0, vol: 0.5 },  // navigasi sub-menu
  CLAIM:       { id: "random.orb",      pitch: 1.0, vol: 1.0 },  // klaim quest reward
  CLAIM_BIG:   { id: "random.levelup",  pitch: 1.0, vol: 1.0 },  // klaim bonus tier / login
  BONUS:       { id: "random.levelup",  pitch: 1.4, vol: 1.0 },  // klaim BONUS KOMPLIT
  ACH_UNLOCK:  { id: "random.levelup",  pitch: 1.6, vol: 0.9 },  // achievement baru terbuka
  QUEST_DONE:  { id: "note.pling",      pitch: 1.5, vol: 0.9 },  // quest baru completed
  SUBMIT:      { id: "random.pop",      pitch: 1.0, vol: 0.8 },  // serahkan item
  FAIL:        { id: "note.bass",       pitch: 0.6, vol: 0.7 },  // gagal / item kurang
  MILESTONE:   { id: "random.levelup",  pitch: 0.7, vol: 1.0 },  // login milestone (7/14/30 hari) — pitch rendah = epic feel
};
