...
// [PERF] Stagger +30 ticks — avoid collision with hologram/pigman/mobcap at tick 100
system.runTimeout(() => { system.runInterval(() => {
  ...
  try {
    ...
    // [PERF] Skip dimension if no players loaded there — keep cached values
