...
import { SERVICE_ROLE_KEY } from "./secrets.js";

export const SUPABASE_URL = "https://jlxtnbnrirxhwuyqjlzw.supabase.co";
// Key diimpor dari secrets.js (di-.gitignore, tidak ikut push ke repo publik)
export const SUPABASE_KEY = SERVICE_ROLE_KEY;
